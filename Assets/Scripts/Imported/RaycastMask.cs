//EDIT:
//Chuck this on any button object and the touch space will be 
//recognisable to only opaque areas. Make sure sprite is set
//to 'advanced' and read/write option is enabled.
//
